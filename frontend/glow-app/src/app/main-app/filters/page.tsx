            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div
                  className="cursor-pointer hover:bg-gray-50 p-4 rounded-lg transition-colors"
                  onClick={() =>
                    router.push("/main-app/filters/filter-options/location")
                  }
                >
                ...
                <div
                  className="cursor-pointer hover:bg-gray-50 p-4 rounded-lg transition-colors"
                  onClick={() =>
                    router.push("/main-app/filters/filter-options/max-distance")
                  }
                >
                ...
                <div
                  className="cursor-pointer hover:bg-gray-50 p-4 rounded-lg transition-colors"
                  onClick={() =>
                    router.push("/main-app/filters/filter-options/age-range")
                  }
                >
