...
export const stepMapping: { [key: string]: number } = {
  ...
  "/onboarding/core-values-section/relationship-type": 7,
  "/onboarding/basic-info-section/dating-preferences": 8,
  "/onboarding/core-values-section/core-values": 9,
  "/onboarding/core-values-section/politics": 10,
  "/onboarding/core-values-section/religion": 11,
